...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: "/ipharmacare-distributed-yb-web/policyImage/file.do"
...
//      ]]
 		, toolbars: [[
            'fullscreen','bold', 'italic','removeformat', 'formatmatch','forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist','cleardoc', '|',
            'rowspacingtop', 'rowspacingbottom', 'lineheight', '|',
...
//        ,emotionLocalization:true //是否开启表情本地化，默认关闭。若要开启请确保emotion文件夹下包含官网提供的images表情文件夹
        ...
        //,maximumWords: 16000000       //允许的最大字符数
