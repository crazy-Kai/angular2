...
import { DetailDataService } from './drugWarningInformationDetails.service';
...
@Component({
	selector:'drugWarningInformationDetailsPage',
    templateUrl:'drugWarningInformationDetails.component.html',
	styleUrls:['drugWarningInformationDetails.component.css'],
	providers:[ DetailDataService ]
})

export class  DrugWarningInformationDetailsComponent{
