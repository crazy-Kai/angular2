...
import { DetailDataService } from './diseaseWarningInformationDetails.service';
...
@Component({
	selector:'diseaseWarningInformationDetailsPage',
    templateUrl:'diseaseWarningInformationDetails.component.html',
	styleUrls:['diseaseWarningInformationDetails.component.css'],
	providers:[ DetailDataService ]
})

export class  DiseaseWarningInformationDetailsComponent{
