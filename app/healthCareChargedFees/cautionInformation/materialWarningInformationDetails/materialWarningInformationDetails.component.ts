...
import { DetailDataService } from './materialWarningInformationDetails.service';
...
@Component({
	selector:'materialWarningInformationDetailsPage',
    templateUrl:'materialWarningInformationDetails.component.html',
	styleUrls:['materialWarningInformationDetails.component.css'],
	providers:[ DetailDataService ]
})

export class  MaterialWarningInformationDetailsComponent{
