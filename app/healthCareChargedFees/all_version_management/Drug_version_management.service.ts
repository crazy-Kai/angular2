...
import {VersionManagementSave,VersionManagementmodification} from './version_management_detail';
@Injectable()
export class DrugVersionManagementService {
    ...
    private inversionListUrl = this.baseName + 'version/list2/YP/';//药品版本管理的列表信息
    ...
    private selectListURL = this.baseName + 'version/list2/comboBox/YP/';//药品添加中的下拉列表    
