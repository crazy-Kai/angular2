...
import {MaterialVersionManagementSave,VersionManagementmodification} from './version_management_detail';
@Injectable()
export class MaterialVersionManagementService {
     ...
     private inversionListUrl = this.baseName + 'version/list2/CL/';//药品版本管理的列表信息
     ...
     private selectListURL = this.baseName + 'version/list2/comboBox/CL/';//药品添加中的下拉列表    
